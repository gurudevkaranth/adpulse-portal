...
function KeyValueRow({ label, value, children }: { label: string; value?: string; children?: ReactNode }) {
  return (
...
export default function AdDetailPanel({ ad, onClose }: AdDetailPanelProps) {
  if (!ad) return null;
