...
import type { Grade, MetricFormat, SparklineDataPoint } from '../../types';
...
export default function MetricCard({ title, value, prevValue, change, sparklineData, grade, format }: MetricCardProps) {
