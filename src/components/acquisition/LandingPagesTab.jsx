...
function getColumns(sparklines) {
  return [
    ...
    {
      key: 'grades.overall', label: 'Grade', align: 'center',
...
export default function LandingPagesTab({ data }) {
  ...
  // Generate sparklines for all rows
    ...
    <>
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-0.5">{filteredData.length} landing pages</p>
        </div>
        <GradeLegend />
      </div>
