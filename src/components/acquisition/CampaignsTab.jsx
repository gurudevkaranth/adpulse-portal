...
const METRIC_COLUMNS = [
  ...
  { key: 'metrics.revenue', label: 'Revenue', defaultVisible: true, tip: 'Total revenue attributed to this campaign' },
...
export default function CampaignsTab({ data, filters, onFiltersChange }) {
        ...
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-base font-semibold text-text-primary flex items-center gap-2">
              ...
              <InfoTip text="Drill into campaign → ad set → ad performance. Click any row to expand." />
            </h2>
            <p className="text-xs text-text-secondary mt-0.5">{filteredData.length} campaigns</p>
          </div>
          <div className="flex items-center gap-2">
            <GradeLegend />
