...
export default function CreativesTab({ ads, filters, onFiltersChange }) {
  ...
  const [visibleColumns, setVisibleColumns] = useState(DEFAULT_VISIBLE_LIST);
