...
interface AssistantMessage extends AIResponse {
  role: 'assistant';
}
...
function generateAIResponse(query: string, ads: Ad[]): AIResponse {
...
export default function AICopilot() {
  const suggestions = generateCopilotSuggestions() as string[];
  ...
  const handleSend = async (text?: string) => {
    ...
    const userMessage: UserMessage = { role: 'user', content: query };
    ...
    const aiMessage: AssistantMessage = { role: 'assistant', ...response };
